...
export const TESTIMONIALS = [
  {
    ...
    rating: 5,
    quote:
      "I just wanted to express my gratitude for the staff at Awtar Beauty center — City Centre Doris. The staff working with Maamar who did so much for me was very genuine, warm and passionate about the work they do. I received a great hair cut, hair dye, beard shave, facial, plus manicure and pedicure.",
  },
  {
    name: "shariq khan",
    rating: 5,
