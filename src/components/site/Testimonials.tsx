    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="mb-12 md:mb-16">
          ...
          <p className="text-white/60 text-sm md:text-base ml-[72px]">
          ...
          >
            <div className="flex gap-6 w-max animate-marquee group-hover:[animation-play-state:paused]">
              {loop.map((t, idx) => (
                <article
                  key={idx}
                  className="w-[300px] md:w-[360px] shrink-0 rounded-xl border border-white/10 bg-white/5 backdrop-blur-md p-6 md:p-7 flex flex-col items-center text-center"
                >
